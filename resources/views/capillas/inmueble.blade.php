...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/jquery.dataTables.min.css') }}">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content">
            ...
            <a href='#addInmueble' class='btn btn-success' data-toggle='modal'>Registrar Inmueble +</a>

            <div class="row">
              <div class="col-md-12">
                <div class="box">

                  <table align="center" class="table table-hover table-striped table-bordered" id="tb_inmuebles" class="display table-responsive" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>No.</th>
                        <th>Nombre</th>
      ...
      <div class="modal fade" id="addInmueble" tabindex="-1" role="dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="signin-form profile">
                <h3 class="agileinfo_sign">Registrar Inmueble</h3>
                <div class="login-form">
                  <form action="{{ action('InmuebleController@addInmueble') }}" method="post">
                      ...
                      <tr>
                        <td>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" required="" placeholder="Silla..">
                          </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <div class="signin-form profile">
                <h3 class="agileinfo_sign">Editar Inmueble</h3>
                <div class="login-form">
                  <form action="{{ action('InmuebleController@editInmueble') }}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="table table-hover">
                      <tr>
                        <td>
                          <div class="form-group">
                            <label for="choose">Nombre</label>
                            <input type="text" class="form-control" id="nombre_edit" name="nombre_edit" required="" placeholder="Silla..">
                          </div>
                        </td>
                      </tr>
                      <tr>
      ...
      <script type="text/javascript">
        ...
        var listar = function(){
          var table = $('#tb_inmuebles').DataTable({
        ...
        "ajax":{
          "method":"get",
          "url":"{{ action('InmuebleController@getInmueble') }}"
        },
        ...
        {"render":function(data,type,full,meta){
          return '<form action="{{ action("InmuebleController@deleteInmueble") }}" method="post"><input type="hidden" name="_token" value="{{ csrf_token() }}"><input type="hidden" name="id_delete" id="id_delete" value="'+full.id+'"><button type="submit" class="btn btn-danger">Eliminar</button></form>';
        }},
        ],
        ...
        "scrollX": true
          ...
          editarInmueble("#tb_inmuebles tbody", table);
        }
        function editarInmueble(tbody, table){
