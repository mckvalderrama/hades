  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <script type="text/javascript">
      ...
      $(document).on('click','.create-modal', function() {
        ...
        $('.modal-capilla').text('Añadir capilla');
      });
      $("#add").click(function() {
        $.ajax({
          type: 'POST',
          ...
          success: function(data){
            if ((data.errors)) {
              ...
              $('.error').remove();
              $('#table').append("<tr class='capilla" + data.id + "'>"+
                "<td>" + data.id + "</td>"+
                "<td>" + data.nombre + "</td>"+
                "<td>" + data.descripcion + "</td>"+
                "<td><button class='show-modal btn btn-info btn-sm' data-id='" + data.id + "' data-nombre='" + data.nombre + "' data-descripcion='" + data.descripcion + "'><span class='fa fa-eye'></span></button> <button class='edit-modal btn btn-warning btn-sm' data-id='" + data.id + "' data-nombre='" + data.nombre + "' data-descripcion='" + data.descripcion + "'><span class='glyphicon glyphicon-pencil'></span></button> <button class='delete-modal btn btn-danger btn-sm' data-id='" + data.id + "' data-nombre='" + data.nombre + "' data-descripcion='" + data.descripcion + "'><span class='glyphicon glyphicon-trash'></span></button></td>"+
                "</tr>");
            }
          },
        });
...
$(document).on('click', '.edit-modal', function() {
  $('#footer_action_button').text(" Actualizar capilla");
  $('#footer_action_button').addClass('glyphicon-check');
  $('#footer_action_button').removeClass('glyphicon-trash');
  $('.actionBtn').addClass('btn-success');
  $('.actionBtn').removeClass('btn-danger');
  $('.actionBtn').addClass('edit');
  $('.modal-capilla').text('Editar capilla');
  $('.deleteContent').hide();
  $('.form-horizontal').show();
...
$('.modal-footer').on('click', '.edit', function() {
  $.ajax({
    ...
    success: function(data) {
      $('.capilla' + data.id).replaceWith(" "+
        "<tr class='capilla" + data.id + "'>"+
        "<td>" + data.id + "</td>"+
        "<td>" + data.nombre + "</td>"+
        "<td>" + data.descripcion + "</td>"+
        "<td><button class='show-modal btn btn-info btn-sm' data-id='" + data.id + "' data-nombre='" + data.nombre + "' data-descripcion='" + data.descripcion + "'><span class='fa fa-eye'></span></button> <button class='edit-modal btn btn-warning btn-sm' data-id='" + data.id + "' data-nombre='" + data.nombre + "' data-descripcion='" + data.descripcion + "'><span class='glyphicon glyphicon-pencil'></span></button> <button class='delete-modal btn btn-danger btn-sm' data-id='" + data.id + "' data-nombre='" + data.nombre + "' data-descripcion='" + data.descripcion + "'><span class='glyphicon glyphicon-trash'></span></button></td>"+
...
$(document).on('click', '.delete-modal', function() {
  ...
  $('.modal-capilla').text('Eliminar capilla');
...
$('.modal-footer').on('click', '.delete', function(){
  ...
  $(document).on('click', '.show-modal', function() {
    ...
    $('#DE').text($(this).data('descripcion'));
    $('.modal-capilla').text('Mostrar Capilla');
  });
</script>
