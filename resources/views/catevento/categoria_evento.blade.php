...
<head>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href='#addCatEventos' class='btn btn-success' data-toggle='modal'>Registrar Evento +</a>
          
          <div class="row">
            <div class="col-md-12">
              <div class="box">

                <table align="center" class="table table-hover table-striped table-bordered" id="tb_cateventos" class="display table-responsive" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>No.</th>
                      <th>Nombre</th>
    ...
    <div class="modal fade" id="addCatEventos" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="signin-form profile">
              <h3 class="agileinfo_sign">Registrar Evento</h3>
              <div class="login-form">
                <form action="{{ action('Categoria_eventoController@addCatEventos') }}" method="post">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <div class="signin-form profile">
              <h3 class="agileinfo_sign">Editar Evento</h3>
              <div class="login-form">
                <form action="{{ action('Categoria_eventoController@editCatEventos') }}" method="post">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  ...
                  <div class="table table-hover">
                    <tr>
                      <td>
                        <div class="form-group">
                          <label for="choose">Nombre</label>
                          <input type="text" class="form-control" id="nombre_edit" name="nombre_edit" required="" placeholder="Cumpleanios difunto..">
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
      ...
      var listar = function(){
        var table = $('#tb_cateventos').DataTable({
        ...
        "ajax":{
          "method":"get",
          "url":"{{ action('Categoria_eventoController@getCatEventos') }}"
        },
        ...
        {"render":function(data,type,full,meta){
          return '<form action="{{ action("Categoria_eventoController@deleteCatEventos") }}" method="post"><input type="hidden" name="_token" value="{{ csrf_token() }}"><input type="hidden" name="id_delete" id="id_delete" value="'+full.id+'"><button type="submit" class="btn btn-danger">Eliminar</button></form>';
        }},
        ],
        ...
        editarCatEvento("#tb_cateventos tbody", table);
      }
      function editarCatEvento(tbody, table){
